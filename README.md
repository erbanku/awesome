...
- [rend871005/export-all-extensions](https://github.com/rend871005/export-all-extensions) - Export name and url of all installed extensions in Google Chrome
...
- [Semporia/TikTok-Unlock](https://github.com/Semporia/TikTok-Unlock) - TikTok免拔卡解锁最新支持 iPhone （iOS 16.2） 、TikTok（V27.6.0）、TikTok TestFlight 27.7.0，支持更换地区 、发布视频 、 直播 、点赞评论、私聊等！
...
- [diddledani/one-script-wsl2-systemd](https://github.com/diddledani/one-script-wsl2-systemd) - The one-script variant of the systemd hack for WSL2
...
- [iBug/pac](https://github.com/iBug/pac) - 科学上网，智能分流，使用 GFWList 和 IP 地址双重判断。现在已有 275 颗 ★
...
- [lxhao61/integrated-examples](https://github.com/lxhao61/integrated-examples) - 以Xray或V2Ray（v4版）、Trojan-Go或Trojan、NaiveProxy、Hysteria等打造科学上网的优化配置及最优组合示例，且提供集成常用插件的Caddy（Caddy2）程序，分享给大家食用及自己备份。
...
- [ClassmateLin/cfdns](https://github.com/ClassmateLin/cfdns) - 测试Cloudflare CDN 延迟，获取最快的IPV4。
