...
- [lalakii/MouseClickTool](https://github.com/lalakii/MouseClickTool) - 简单好用的鼠标连点器（软件仅15KB）
...
- [SSPanel-NeXT/Docs](https://github.com/SSPanel-NeXT/Docs) - 
...
- [netptop/siteproxy](https://github.com/netptop/siteproxy) - reverse proxy, online proxy, 反向代理,免翻墙访问Youtube/twitter/Google, 支持github和telegram web登录(请注意不要通过不信任的代理进行登录)。
...
- [itgoyo/TelegramGroup](https://github.com/itgoyo/TelegramGroup) - 2024最新~悄咪咪收集的5000+个Telegram群合集，附带全网最有趣最好用的机器人BOT🤖
...
- [iBug/pac](https://github.com/iBug/pac) - 科学上网，智能分流，使用 GFWList 和 IP 地址双重判断。现在已有 427 颗 ★
...
- [yomige/docker-v2ray](https://github.com/yomige/docker-v2ray) - 使用docker-compose以ws+tls方式一键部署v2ray。
...
- [qxchuckle/vsc-cec-ide](https://github.com/qxchuckle/vsc-cec-ide) - 一个插件，国产化你的VSCode，来源于CEC-IDE，有敏感词检测、防沉迷等功能。
